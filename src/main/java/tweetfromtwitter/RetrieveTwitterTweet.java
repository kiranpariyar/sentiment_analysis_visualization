...
public class RetrieveTwitterTweet {
...
//    private static ArrayList<Tweet> tweetObjectList;
    ...
    public ArrayList<BrandData> getBrandData(ArrayList<BrandData> brand){
        return brand;
    }


    //    public static ArrayList<BrandData> getTweetList() {
    public static ArrayList<Tweet> getBrandTweets(ArrayList<BrandData> brand){

        //  Creating Tweet List
        tweetObjectList = new ArrayList<Tweet>();

        for (BrandData aBrandData : brand) {

            String SEARCH_TERM = aBrandData.getSearchTerm();
...
//                    Query q = new Query(SEARCH_TERM);            // Search for tweets that contains this term
				...
				q.setUntil(sdf.format(endDate));*/
                    ...
                    /*System.out.printf("At %s, @%-20s said:  %s\n",
                        ...
                        tweetObject.setBrandName(aBrandData.getBrandName());
