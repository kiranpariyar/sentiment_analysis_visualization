    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    <g:link controller="Dashboard" action="summary"><span class="nav-label"><i class="fa fa-th-large"></i>Sammary</span></g:link>
                </li>
                <li>
                    <g:link controller="Graph" action="statistics"><span class="nav-label"><i class="fa fa-bar-chart-o"></i>Graphs</span></g:link>
                </li>
                ...
                <li>
                    <g:link controller="Brand" action="form"><span class="nav-label"><i class="fa fa-edit"></i>Add Brand</span></g:link>
                </li>
                ...
                <div class="navbar-header">
                    ...
                    %{--<form role="search" class="navbar-form-custom" action="">--}%
                        %{--<div class="form-group">--}%
                            %{--<input type="text" placeholder="brand or product" class="form-control" name="top-search" id="top-search">--}%
                        %{--</div>--}%
                    %{--</form>--}%
                </div>
